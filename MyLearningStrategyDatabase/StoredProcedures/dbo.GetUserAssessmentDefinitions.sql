...
END
	...
	BEGIN
		...
		SortRuleId, QuestionRandom, 
		QuestionMax, QuestionMin, 
		ResponseRandom, ResponseMax, 
		ResponseMin, ResponseMinCorrect, 
		ResponseMaxCorrect, AppliedTaxonomyId,
		Taxonomy, LastModifiedOffset, CloudRowId
