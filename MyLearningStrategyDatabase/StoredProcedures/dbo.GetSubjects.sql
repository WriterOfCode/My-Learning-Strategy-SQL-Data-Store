...
BEGIN
	SELECT BOK.BodyOfKnowledgeId as Id,BOK.UserProfileId,BOK.Name,BOK.Description, BOK.Keywords,
...
ELSE
	BEGIN 
		...
		SELECT TOP 1 BOK.BodyOfKnowledgeId as Id,BOK.UserProfileId,BOK.Name,BOK.Description, BOK.Keywords, 
		BOK.ImageDevice, BOK.ImageCloud,BOK.ImageHash, 
		BOK.IsShared, BOK.HasBeenShared, BOK.LastModifiedOffset, BOK.CloudRowId
		FROM [BodyOfKnowledge] BOK
		JOIN UserProfiles U ON U.UserProfileId = BOK.UserProfileId
